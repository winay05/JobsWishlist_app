      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", (0, _alerts.showAlert)('error', "Passwords don't match!"));
...
if (signupForm) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee(e) {
      var name, email, passwordConfirm, password;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault(); // console.log('in signup form');
